...
HD_PWD='/home/omre/4A/projetAutomEtHW/projet/Systeme_info/Systeme_info/PartieHardware/PartieHW/PartieHW.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log CheminDesDonnees.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source CheminDesDonnees.tcl
