...
HD_PWD='/home/omre/4A/projetAutomEtHW/projet/Systeme_info/Systeme_info/PartieHardware/PartieHW/PartieHW.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log CheminDesDonnees.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source CheminDesDonnees.tcl -notrace
